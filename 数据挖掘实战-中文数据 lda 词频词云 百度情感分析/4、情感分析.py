...
def emotion_analysis(text):
    ...
    for result in results:
        ...
        if label == 'negative' and score <= 0.3:
            label_class = '轻度消极'
        elif label == 'negative' and 0.3 < score <= 0.7:
            label_class = '消极'
        elif label == 'negative' and 0.7 < score:
            label_class = '强烈消极'
        elif label == 'positive' and score <= 0.3:
            label_class = '轻度积极'
        elif label == 'positive' and 0.3 < score <= 0.7:
            label_class = '积极'
        elif label == 'positive' and 0.7 < score:
            label_class = '强烈消极'
