...
stop_words = ['ccp','br','de','la','en','da','amp','el','por','du','je','cha','don','bro','se','gz','ich','uk','soo','ppl','ho','st','di','ist','siu']
...
def lda(df):
    ...
    data = pd.DataFrame()
    data['内容'] = df['clearn_text']
    data['主题概率'] = list3
    data['主题类型'] = list2

    data.to_csv('./LDA/lda_data.csv',encoding='utf-8-sig',index=False)
