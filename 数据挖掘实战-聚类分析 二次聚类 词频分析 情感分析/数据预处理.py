...
def get_cut_words(content_series):
    try:
        ...
        for word, flag in words:
            ...
            if flag in ['an', 'Ng', 'n', 'nr', 'ns', 'nt', 'nz']:
...
with open('全部评论.txt','r',encoding='gbk') as f:
    content = f.readlines()

content1 = [c.strip('\n').strip("") for c in content]
content2 = [c for c in content1[::2]]
content2 = content2[1:]
...
new_df.to_csv('data1.csv',index=False,encoding='utf-8-sig')
