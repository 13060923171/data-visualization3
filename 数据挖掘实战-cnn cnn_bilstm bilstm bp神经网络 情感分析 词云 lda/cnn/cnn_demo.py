...
# 加载新的数据
new_data_df = pd.read_excel('../new_data.xlsx')
new_data = list(new_data_df['content'])
...
new_data_df['情感type'] = new_predicted_classes
...
new_data_df['情感type'] = new_data_df['情感type'].apply(demo2)

new_df = new_data_df['情感type'].value_counts()
