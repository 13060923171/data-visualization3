...
data['推文'] = data['推文'].astype(str)
data['translate'] = data['推文'].apply(translate)
...
new_data = data.dropna(subset=["new_推文"])
new_data.to_csv('new_推特.csv',encoding="utf-8-sig",sep=',',index=False)
