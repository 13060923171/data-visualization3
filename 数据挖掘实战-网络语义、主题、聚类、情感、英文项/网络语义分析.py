...
def main():
    # word = [] #记录关键词
    # f = open("result-fenci-1.txt", encoding='utf-8')
    # line = f.readline()
    # while line:
    #     #print line
    #     line = line.replace("\n", "") #过滤换行
    ...
    """ 第四步:图形生成 """
    with open('./数据集/word_node_1.txt','r',encoding='utf-8')as f:
        content = f.readlines()
    list_word1 = []
    list_word2 = []
    list_weight = []
    ...
    plt.title("聚类1-网络语义")
    plt.savefig('聚类1-网络语义.png')
    plt.show()


def main1():
    # word = [] #记录关键词
    # f = open("result-fenci-0.txt", encoding='utf-8')
    # line = f.readline()
    # while line:
    #     #print line
    #     line = line.replace("\n", "") #过滤换行
    ...
    # f.close()
    #
    # words = codecs.open("word_node_0.txt", "w", "utf-8")
    # i = 0
    # while i < len(word):
    #     student1 = word[i]
    #     j = i + 1
    ...
    """ 第四步:图形生成 """
    with open('./数据集/word_node_0.txt','r',encoding='utf-8')as f:
        content = f.readlines()
    list_word1 = []
    list_word2 = []
    list_weight = []
    ...
    nx.draw_networkx_nodes(G, pos, alpha=0.7,node_size=1600)
    nx.draw_networkx_edges(G,pos,width=0.5,alpha=0.8,edge_color='g')
    nx.draw_networkx_labels(G, pos, font_family='sans-serif', alpha=1,font_size='20')
    plt.title("聚类0-网络语义")
    plt.savefig('聚类0-网络语义.png')
    plt.show()
